...
#include "sensors/sensors.h"
    ...
    !defined(USE_GYRO_SPI_ICM42605) && !defined(USE_GYRO_SPI_ICM42688P)  && !defined(USE_GYRO_SPI_ICM42622P) && \
...
#if defined(USE_GYRO_SPI_ICM42605) || defined(USE_GYRO_SPI_ICM42688P) || defined(USE_GYRO_SPI_ICM42622P)
    case GYRO_ICM42605:
    case GYRO_ICM42688P:
    case GYRO_ICM42622P:
