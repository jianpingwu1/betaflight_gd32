...
#include "acceleration_init.h"
    ...
    !defined(USE_ACCGYRO_BMI270) && !defined(USE_ACC_SPI_ICM42605) && !defined(USE_ACC_SPI_ICM42688P) && !defined(USE_ACC_SPI_ICM42622P) && \
...
#if defined(USE_ACC_SPI_ICM42605) || defined(USE_ACC_SPI_ICM42688P) || defined(USE_ACC_SPI_ICM42622P)
    case ACC_ICM42605:
    case ACC_ICM42688P:
    case ACC_ICM42622P:
