...
#endif /* GD32F450 || GD32F470 || (GD32F405) || defined (GD32F425)  defined (GD32F407) || defined (GD32F427)  */
...
//PORTA
    ...
    // DEF_TIMER(TIMER0, CH0N, PA11, 0, 0),
...
//PORTB
    ...
    // DEF_TIMER(TIMER1, CH0,  PB8, 0, 0),
    // DEF_TIMER(TIMER1, CH1,  PB9, 0, 0),    
...
/*
    ...
    there are only certain DMA channels/subperis available for certain timers and subperis.
     *** (this may highlight some hardware limitations on some targets) ***

    DMA0

    Subperi Channel0        Channel1        Channel2        Channel3        Channel4        Channel5        Channel6        Channel7
    0
    1
    2       TIMER3_CH0                                      TIMER3_CH1                                                      TIMER3_CH2
    3                       TIMER1_CH2                                                      TIMER1_CH0      TIMER1_CH0      TIMER1_CH3
                                                                                                            TIMER1_CH3
    4
    5                                       TIMER2_CH3                      TIMER2_CH0      TIMER2_CH1                      TIMER2_CH2
    6       TIMER4_CH2      TIMER4_CH3      TIMER4_CH0       TIMER4_CH3     TIMER4_CH1
    7

    DMA1

    Subperi Channel0        Channel1        Channel2        Channel3        Channel4        Channel5        Channel6        Channel7
    0                                       TIMER7_CH0                                                      TIMER0_CH0
    ...
    4                          
    5
    6       TIMER0_CH0      TIMER0_CH1      TIMER0_CH0                      TIMER0_CH3                      TIMER0_CH2
    7                       TIMER7_CH0      TIMER7_CH1      TIMER7_CH2                                                      TIMER7_CH3
*/
...
uint32_t timerClock(TIM_TypeDef *tim) 
{
    ...
    if (timer == TIMER7 || timer == TIMER0 || timer == TIMER8 || timer == TIMER9 || timer == TIMER10) {
        return SystemCoreClock;      // APB2
    } else {
        return SystemCoreClock / 2;  // APB1
    }
}
...
{
    timer_counter_value_config((uint32_t)timer, counter);
}
