...
{
    // This function is intentionally left empty as pin configuration is handled in SD_Initialize_LL
    // and the pin definitions are obtained from sdioPinConfig()
}

void SDIO_GPIO_Init(void)
{
    // This function is intentionally left empty as GPIO initialization is handled in SD_Initialize_LL
    // and the pin definitions are obtained from sdioPinConfig()
}
...
bool SD_Initialize_LL(DMA_Stream_TypeDef *dma)
{
    ...
    // const IO_t d0 = IOGetByTag(IO_TAG(PB13));
