...
// H7 DEF_TIMER includes an extra upopt parameter for TIM_UP DMA channel
...
// H7 uses DMAMUX: DMA request is separate from channel assignment
#define DEF_TIM_DMA_REQUEST(timch) \
    CONCAT(DEF_TIM_DMA_REQ__, DEF_TIM_TCH2BTCH(timch))

// H7 DMA stream macro: D(dma_n, stream_n) - no channel param for H7
#define DEF_TIM_DMA_STREAM(variant, timch)                              \
    CONCAT(DEF_TIM_DMA_STREAM__, DEF_TIM_DMA_GET(variant, timch))
...
/* H7 Channel Mappings */
// D(DMAx, Channel) -- H7 has DMAMUX allowing any assignment
...
// TIM_UP DMA table (all channels available via DMAMUX)
...
#define DEF_TIM_DMA__BTCH_TIMER6_UP     DEF_TIM_DMA_FULL
#define DEF_TIM_DMA__BTCH_TIMER7_UP     DEF_TIM_DMA_FULL

// DMA request ID mapping (TIMx_CHy -> DMAMUX request)
...
// AF table for H7 (uses same GPIO_AF numbering as F4 for shared pins)
#define DEF_TIM_AF__NONE__TCH_TIMER0_CH0     D(1, 0)
#define DEF_TIM_AF__NONE__TCH_TIMER0_CH1     D(1, 0)
#define DEF_TIM_AF__NONE__TCH_TIMER0_CH2     D(1, 0)
#define DEF_TIM_AF__NONE__TCH_TIMER0_CH3     D(1, 0)
...
#define HARDWARE_TIMER_DEFINITION_COUNT 14
#define TIMUP_TIMERS ( BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7) )
