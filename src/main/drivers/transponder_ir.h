...
#elif defined(STM32F4) || defined(STM32F7) || defined(STM32H7) || defined(STM32G4) || defined(GD32F4) || defined(GD32H7)
...
typedef struct transponder_s {
    ...
    #if defined(STM32F4)|| defined(STM32F7) || defined(STM32H7) || defined(STM32G4) || defined(GD32F4) || defined(GD32H7) || defined(UNIT_TEST)
