...
// Generate USE_SPI_GYRO
    ...
    || defined(USE_GYRO_L3GD20) || defined(USE_GYRO_SPI_ICM42605) || defined(USE_GYRO_SPI_ICM42688P) || defined(USE_GYRO_SPI_SH5001) || defined(USE_ACCGYRO_ICM45686) \
