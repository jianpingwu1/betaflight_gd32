...
#Flags
ARCH_FLAGS      = -mthumb -mcpu=cortex-m7 -march=armv7e-m -mfloat-abi=hard -mfpu=fpv5-d16
...
else ifeq ($(TARGET_MCU),GD32H759vi)
DEVICE_FLAGS       += -DGD32H759 -DGD32H7XXV
DEFAULT_LD_SCRIPT  = $(LINKER_DIR)/gd32h759xi_flash.ld
STARTUP_SRC        = GD32/startup/startup_gd32h759.S
MCU_FLASH_SIZE     := 2048
